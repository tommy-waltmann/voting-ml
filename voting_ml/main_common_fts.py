...
def main():
    ...
    '''2. Use unnecess_que_file="../extern/manage_data/list_unnecessary_columns.txt"
    all_fts = False
    outdir = "../results/run_common_1_sel_fts/"
    3. Use unnecess_que_file="../extern/manage_data/list_2_unnecessary_columns.txt"
    all_fts = True
    outdir = "../results/run_common_2_all_fts/"
    4. Use unnecess_que_file="../extern/manage_data/list_2_unnecessary_columns.txt"
    all_fts = False
    outdir = "../results/run_common_2_sel_fts/"
    5. Use unnecess_que_file="../extern/manage_data/list_3_unnecessary_columns.txt"
    all_fts = True
    outdir = "../results/run_common_3_all_fts/"
    6. Use unnecess_que_file="../extern/manage_data/list_3_unnecessary_columns.txt"
    all_fts = False
    outdir = "../results/run_common_3_sel_fts/"
    5. Use unnecess_que_file="../extern/manage_data/list_4_unnecessary_columns.txt"
    all_fts = True
    outdir = "../results/run_common_4_all_fts/"
    6. Use unnecess_que_file="../extern/manage_data/list_4_unnecessary_columns.txt"
    all_fts = False
    outdir = "../results/run_common_4_sel_fts/"
    5. Use unnecess_que_file="../extern/manage_data/list_5_unnecessary_columns.txt"
    all_fts = True
    outdir = "../results/run_common_5_all_fts/"
    6. Use unnecess_que_file="../extern/manage_data/list_5_unnecessary_columns.txt"
    all_fts = False
    outdir = "../results/run_common_5_sel_fts/"
    '''
            ...
            for thres in list_corr_threshold:
                ...
                if(all_fts):
                    ...
                    for K in list_Kfold:
                        ...
                        model_obj = model_sel.model_sel(ts, run_num, 'common', param_space, K, len(same_selected_questions), thres, same_sel_data_dict ,weights_dict, same_selected_questions, outdir).select_model()

                        acc.append(model_obj['test_acc'])

                        o_models_file.write(str(ts)+",")
                        o_models_file.write(str(run_num)+",")
                        o_models_file.write("common,")
