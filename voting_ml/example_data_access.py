...
def main():
    ...
    print(poll_data._dataframe.values.shape)
    ...
    all_answers, all_questions = poll_data.all_data()
    ...
    print(question_set_answers)
    question_set_answers_except = poll_data.all_data_except(["Q1", "Q27_6", "Q14", "educ"])
    print(question_set_answers_except)
    ...
    # answer in them
    question_set_answers = poll_data.all_data(["Q2_1", "Q18_5", "Q22", "voter_category","ppage"])
    print(question_set_answers)
